...
namespace Biller.UI.TreeView
{
    public sealed class TreeViewItemHelper
    {
        private TreeViewItemHelper()
        {
        }
        ...
        {
            return Convert.ToBoolean(obj.GetValue(IsMouseDirectlyOverItemProperty));
        }
